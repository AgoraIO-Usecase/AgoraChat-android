 ...
 * 热爱生活每一天！
 */
public class GroupCreateFragment extends ContactListFragment implements View.OnClickListener, CustomTitleBarFragment {
    ...
    private void createNewGroup() {
        if(getParentFragment()!=null&&getParentFragment() instanceof GroupContainerFragment) {
            ((GroupContainerFragment)getParentFragment()).startFragment(new NewGroupFragment(),null);
        }
    }
