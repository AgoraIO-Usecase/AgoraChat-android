 ...
 * 热爱生活每一天
 */
public class NewGroupSelectContactsFragment extends BaseInitFragment implements BottomSheetChildHelper {
    @Override
    protected int getLayoutId() {
        return R.layout.fragment_new_group_select_contacts;
    }
